    ...
    <Layout>
      <section className="relative pt-5 mb-5 min-h-[calc(100vh -90px)]" style={{maxHeight: 'calc(100vh - 100px)'}}>
        <div className="container mx-auto px-6 md:px-16">
          <div className="flex flex-col">
            <p className="mb-8 md:mb-0 relative text-lg  text-end font-semibold italic after:bg-heroLineCurve after:absolute after:top-[60%] after:right-0 after:h-[30px] after:w-[400px] after:bg-no-repeat after:bg-right after:bg-30% after:animate-[fadeInRight_0.5s_0.2s_ease_forwards]">Igniting a Revolution in HR Innovation</p>
            <div className="flex flex-col md:flex-row justify-center items-center">
              <div className="flex flex-col justify-center items-center md:items-start w-full md:w-[40%] py-6 pt-10">
                <div className="flex relative flex-col justify-center text-center md:text-left mb-7">
                  <h1 className="text-white text-[2.5rem] md:text-6xl font-semibold font-clashDisplay">getlinked Tech</h1>
                  <h1 className="flex text-white text-4xl md:text-5xl font-semibold font-clashDisplay">Hackathon  &nbsp;<span className="text-primaryPink"> 1.0</span> <span className="flex"><img className="w-10 h-10 md:w-14 md:h-14" src={chainSvg} alt="chain" /><img className="w-10 h-10 md:w-14 md:h-14" src={blastSvg} alt="blast icon" /></span></h1>
                  <p className="text-md max-w-[90%] md:max-w-full">Participate in getlinked tech Hackathon 2023 stand a chance to win a Big prize</p>
                    <img className="absolute top-[-30px] right-[10%]  w-10 h-10" src={bulbSvg} alt="bulb" />
                    <img className="absolute top-[-94px] md:top-[-310px] right-[86px] md:right-[5px] rotate-[270deg] md:rotate-0 bg-blend-hard-light -z-20" src={purpleFlareImg} alt="" style={{background: '-155.25px -155px / 114.411% 118.9% no-repeat'}}/>
                    <img className="hidden md:block absolute top-[-130px] left-[10%] h-5 w-5 z-20" src={whiteStar} alt="" />
                </div>
                <Link to="/register">
              ...
              <div className="relative flex justify-center items-center w-full md:w-[60%] pt-6">
      ...
      <section className="relative py-5 mb-5">
        <div className="container mx-auto px-6 md:px-16">
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="relative flex flex-col justify-center w-full md:w-[50%] pt-10 pb-5 text-center md:text-left">
              <div className="text-3xl md:text-4xl font-semibold font-clashDisplay ">Introduction to getlinked</div>
      ...
      <section className="relative py-5 mb-5">
        <div className="container mx-auto px-6 md:px-16">
          ...
          <img className="absolute top-[-15px] left-[-24%] md:left-[4%] opacity-80 w-auto md:w-[50%] h-[50%] md:h-[80%] -z-20" src={purpleFlareImg} alt="" />
      ...
      <section className="relative py-5 mb-5">
        <div className="container mx-auto px-6 md:px-16">
          ...
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="relative flex flex-col justify-start items-center md:items-start w-full md:w-[50%] pt-10 pb-5 text-center md:text-left">
      ...
      <section className="relative py-5 mb-5">
        <div className="container mx-auto px-6 md:px-16">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            <div className="relative flex flex-col justify-center items-center md:items-start w-full md:w-[50%] pt-10 pb-5 text-center md:text-left">
      ...
      <section className="relative py-5 mb-5" id="
      ">
        <div className="container mx-auto px-6 md:px-16">
          <div className="flex flex-col justify-center items-center gap-10">
            <div className="text-center max-w-full md:max-w-[30%]">
      ...
      <section className="relative py-5 mb-5">
        <div className="container mx-auto px-6 md:px-16">
         <img className="absolute bottom-[-50%] right-[-35%] w-[80%] -z-20 opacity-70 rotate-[117deg]" src={purpleFlareImg} alt="" />
          <img className="absolute top-[-15px] left-[-24%] md:left-[4%] opacity-80 w-auto md:w-[50%] h-[50%] md:h-[80%] -z-20" src={purpleFlareImg} alt="" />
              <div className="ml-0 md:ml-[50%] mb-10 text-center md:text-left">
                <div className="flex flex-col justify-center items-center md:items-start text-4xl font-semibold font-clashDisplay">Prizes and</div>
                <div className="text-primaryPink text-4xl  font-semibold font-clashDisplay leading-[2]">Rewards</div>
                <p className="text-sm leading-7 max-w-[90%] md:max-w-[60%]">Highlight of the prizes or rewards for winners and for participants</p>
              </div>
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="relative flex flex-col justify-start w-full md:w-[60%] pt-10 pb-5 text-left">
              ...
              <img className="absolute bottom-[-10%] right-[30%] h-5 w-5" src={grayStar} alt="" />
                <div className="flex flex-col min-w-[6.5rem] min-h-[9.6rem] md:min-w-[12.5rem] md:min-h-[15.6rem] justify-end items-center text-center relative p-4 rounded-[8px] hover:shadow-xl border border-primaryPink bg-[#d434fe1f]">
                  <img className="absolute bottom-[80%] left-[6px] scale-[1.2]" src={silverMedal} alt="Gold Medal" />
                    ...
                    <p className="text-lg text-primaryPink font-semibold">N300,000</p>
                </div>
                <div className="flex flex-col min-w-[6.5rem] min-h-[11.5rem] md:min-w-[12.5rem] md:min-h-[17.5rem] justify-end items-center text-center relative p-4 rounded-[8px] hover:shadow-xl border border-[#903AFF] bg-[#903aff1f]">
                  <img className="absolute bottom-[80%] left-[2px] scale-[1.35]" src={goldMedal} alt="Gold Medal" />
                    ...
                    <p className="text-lg text-[#903AFF] font-semibold">N400,000</p>
                </div>
                <div className="flex flex-col min-w-[6.5rem] min-h-[7.75rem] md:min-w-[12.5rem] md:min-h-[13.75rem] justify-end items-center text-center relative p-4 rounded-[8px] hover:shadow-xl border border-primaryPink bg-[#d434fe1f]">
                  <img className="absolute bottom-[80%] left-[10px]" src={bronzeMedal} alt="Gold Medal" />
                    ...
                    <p className="text-lg text-primaryPink font-semibold">N150,000</p>
                </div>
              </div>
            </div>
          </div>
         ...
         <img className="absolute bottom-[-50%] right-[-35%] w-[80%] -z-20 opacity-70 rotate-[117deg]" src={purpleFlareImg} alt="" />
          <img className="absolute top-[-15px] left-[-24%] md:left-[4%] opacity-80 w-auto md:w-[50%] h-[50%] md:h-[80%] -z-20" src={purpleFlareImg} alt="" />
              <div className="flex flex-col justify-center items-center text-center mb-6">
                <div className="text-3xl md:text-4xl font-semibold font-clashDisplay">Partners and Sponsors</div>
                <p className="text-sm leading-7 max-w-[90%] md:max-w-[60%] text-center">Getlinked Hackathon 1.0 is honored to have the following major companies as its partners and sponsors</p>
              </div>
          <div className="flex justify-center items-center rounded-[5px] border border-primaryPink bg-[#ffffff03] p-10">
            <div className="grid grid-cols-3 gap-10">
              <div className="relative max-w-[250px]  p-2 md:p-6 flex justify-center items-center"> <img  src={libertyLogo} alt="" /></div>
              <div className="relative max-w-[250px] p-2 md:p-6 flex justify-center items-center border-x  border-x-primaryPink"> <img  src={libertyPayLogo} alt="" /></div>
              <div className="relative max-w-[250px] p-2 md:p-6 flex justify-center items-center"> <img  src={winwiseLogo} alt="" /></div>
              <div className="relative  max-w-[250px] p-2 md:p-6 flex justify-center items-center before:content-[''] before:w-full before:absolute before:top-[-22px] before:left-0 before:h-[1px] before:bg-primaryPink"> <img  src={wisperLogo} alt="" /></div>
              <div className="relative max-w-[250px] p-2 md:p-6 flex justify-center items-center border-x border-x-primaryPink before:content-[''] before:w-[80%] before:absolute before:top-[-22px] before:left-[10%] before:h-[1px] before:bg-primaryPink"> <img src={payboxLogo} alt="" /></div>
              <div className="relative max-w-[250px] p-2 md:p-6 flex justify-center items-center  before:content-[''] before:w-full before:absolute before:top-[-22px] before:left-0 before:h-[1px] before:bg-primaryPink"> <img  src={visualplusLogo} alt="" /></div>
            </div>
          </div>
        </div>
      </section>
